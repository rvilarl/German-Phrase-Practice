...
const replacements = [
    ...
    { from: "'Russian translation of the text, ONLY if type is \\'german\\'.'", to: "`${getLang().native} translation of the text, ONLY if type is 'learning'.`" },
    ...
    { from: "'The Russian translation of the German sentence.'", to: "`The ${getLang().native} translation of the ${getLang().learning} sentence.`" },
    { from: "'The correct German translation of the provided Russian phrase.'", to: "`The correct ${getLang().learning} translation of the provided ${getLang().native} phrase.`" },
    ...
    { from: 'Translate this Russian phrase to German:', to: '`Translate this ${getLang().native} phrase to ${getLang().learning}:`' },
    { from: 'Translate this German phrase to Russian:', to: '`Translate this ${getLang().learning} phrase to ${getLang().native}:`' },
    ...
    { from: 'Your main conversational responses should be in German. Only use Russian for explanations', to: 'Your main conversational responses should be in ${getLang().learning}. Only use ${getLang().native} for explanations' },
    { from: "'text' for Russian explanations, 'german'", to: "'text' for ${getLang().native} explanations, 'learning'" },
