...
<div className="flex justify-center items-center gap-4 py-4 px-4 border-t border-slate-700/50">
  <button
    onClick={onAddPhrase}
  ...
  >
    ...
    <span className="hidden sm:inline">{t("categories.detail.actions.aiAssistant")}</span>
        ...
        <div className="h-[85px] p-4 flex-grow overflow-y-auto hide-scrollbar">
          {phrases.length > 0 ? (
            <>
